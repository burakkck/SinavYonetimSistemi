...
<div class="col-lg-6">
	<div class="page-header" style="margin-top: -8px">
		<h1 style="color: #000000;">Derslik Ekle</h1>
	</div>
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<strong>Derslik Ekle </strong>
				</h3>
			</div>
			<div class="panel-body">
				<form action="derslikekle" id="derslikekle" method="post"
					class="form-horizontal">
					<div class="form-group">
						<label class="col-lg-2 control-label">Derslik Ad</label>
						<div class="col-lg-5">
							<input type="text" class="form-control" name="name" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">Sıra Sayısı</label>
						<div class="col-lg-5">
							<input type="text" class="form-control" name="sirasayisi" />
						</div>
					</div>
					<div class="form-group">
