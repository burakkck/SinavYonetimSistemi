...
<body>
	...
	<!-- /Header -->
<div class="row">
<div class="col-lg-5 col-lg-offset-4" style="margin-top: 130px; margin-left: 400px;">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" method="post" action="hocalogin">
					...
					<button type="submit" class="btn btn-sm btn-default">Giriş
						Yap</button>
				</form>
			</div>
		</div>
