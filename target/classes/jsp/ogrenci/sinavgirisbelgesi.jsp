...
<%-- 								<a href="tekbelgeyazdir?sinavID=${sinavID }" style="margin-left: 30%;" class="btn btn-default btn-lg" type="button"><i class="fa fa-print"></i> Yazdır</a> --%>
					...
					<table border="1" bordercolor="#ddd">
						...
						<tr>
							...
							<td height="40" width="500"><label><b>&nbsp SINAV TARİHİ :</b></label><span> ${sinav.tarih }</span></td>
						</tr>
