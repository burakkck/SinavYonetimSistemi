...
<body>
<%-- <%@include file="ogrenciheader.jsp" %> --%>
<br><br>
<!-- 	<div class="container"> -->
<div class="col-lg-offset-2 col-lg-8">
<!-- 		<div class="page-header" style="margin-top: -8px"> -->
<!-- 		<h1 style="color: #000000;">Kayıt</h1> -->
<!-- 	</div> -->
...
<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="ogrencikayit" method="post" class="form-horizontal" id="addogrenci" enctype="multipart/form-data" >
				<div class="form-group">
					<label class="col-sm-2 control-label">Öğrenci No</label>&nbsp;<span class="ogrno"></span>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"  >E-Posta</label>&nbsp;<span class="status"></span>
					<div class="col-md-6">
				...
				<div class="form-group">
						...
						<div class="col-lg-6">
							<select title="Bölüm Seçiniz"
								class="form-control bolum-select" id="bolum-select" data-live-search="true"
								name="bolum" disabled>
			...
			<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-md-6">
						<input type="submit" name="kayit" id="kayit" value = "Kayıt Ol" class="btn btn-primary">
					</div>
				</div>
			</form>
			</div>
