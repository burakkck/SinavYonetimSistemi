						...
						<table border='1' bordercolor="#ddd">
							<tr>
								<th height="180" colspan="5">
									...
									<img class="img-thumbnail" style="width: 120px; height: 150px; float: right; margin-right: 10px;" src="imagecontrol?oid=<%=ogr_id %>" alt="..."/> 
								</th> 
							</tr>
					...
					<br/>
						<table border="1" bordercolor="#ddd">
							...
							<tr>
								...
								<th style="width: 200px;">&nbsp Tarih</th>
...
<!-- 			<input onclick="window.print();" type="button" value="Sayfayı Yazdırın"/> -->
